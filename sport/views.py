...
class ConfirmGrade(APIView):
    ...
    def post(self,request):
        ...
        print(score_dict["score_sum"])
        print((float(score_dict["score_sum"])-float(score_dict["score_max"])-float(score_dict["score_min"])))
        print((score.count() - 2) * score.count() + float(data["D"]) - float(data["P"]))
        try:
            score_avg = (float(score_dict["score_sum"])-float(score_dict["score_max"])-float(score_dict["score_min"]))/ \
